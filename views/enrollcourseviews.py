...
class RegisteredCourseListView(APIView):
    ...
    def get(self, request, format=None):
        try:
            ...
            return Response({"error": "Course or customer not found."}, status=status.HTTP_404_NOT_FOUND)
...
class DisplayCourseEnrollmentView(APIView):
    ...
    def get(self, request, format=None):
        try:
            ...
            return Response({"error": "Validation error occurred: " + str(validation_error)}, status=status.HTTP_400_BAD_REQUEST)
        except Exception as e:
...
class EnrolledCoursesListDisplayView(APIView):
    ...
    def get(self, request, format=None):
        try:
            ...
            # Assuming some logic to retrieve enrolled courses for the user
            enrolled_courses = CourseEnrollment.objects.filter(user_id=user_id)
    ...
    [
    {
        ...
        "course": 2,
        "enrolled_at": "2024-04-08T06:50:13.204005Z",
        "updated_at": "2024-04-08T07:09:29.952113Z",
        "active": true,
        "deleted_at": null
    },
    {
        "id": 2,
        "course": 1,
        "enrolled_at": "2024-04-08T06:54:45.470542Z",
        "updated_at": "2024-04-08T06:54:45.470542Z",
        "active": true,
        "deleted_at": null
    },
    {
